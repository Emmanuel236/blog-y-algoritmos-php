...
<body>
	...
	<nav class="menu">
		...
		<br>
	<div class="container">
	<h2>Calcular el pago al SAR</h2>
		<form action="sar.php" method="post" class="sar-form">
			Porcentaje a depositar (%): <input type="number" name="porcentaje" required><br>
			<input type="submit" name="submit" value="Calcular pago al SAR" class="submit-button">
		</form>
		<?php
		if (isset($_POST['submit'])) {
			$porcentaje = $_POST['porcentaje'];
			$montoInicial = 1200000;
			$descuento = ($montoInicial * $porcentaje) / 100;
			$pagoMensual = $montoInicial - $descuento;
			
			echo "<p class='resultado'>Descuento porcentaje: " . $descuento . "</p>";
			echo "<p class='resultado'>Pago mensual: " . $pagoMensual . "</p>";
		}
		?>
	</div>
</body>
