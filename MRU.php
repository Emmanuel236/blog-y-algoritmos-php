...
<body>
	...
	<nav class="menu">
		...
		<br>
	<div class="container">
	<h2>Calcular la velocidad de un móvil en M.R.U.</h2>
	<form action="MRU.php" method="post" class="nota-form">
		Distancia recorrida: <input type="number" name="distancia" step="0.01" required><br> 
		Tiempo transcurrido: <input type="number" name="tiempo" step="0.01" required><br>
		<input type="submit" name="submit" value="Calcular velocidad" class="submit-button">
	</form>
	<?php
	if (isset($_POST['submit'])) {
		...
		echo "<p class='resultado'>La velocidad del móvil en M.R.U. es: " . $velocidad . " unidades por unidad de tiempo.</p>";
	} 
	?>
	</div>
</body>
