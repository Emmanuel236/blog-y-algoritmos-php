...
<body>
	...
	<div class="container">
		...
		<form action="triangulo.php" method="post" class="area-form">
			Base: <input type="number" name="base" required><br>
			Altura: <input type="number" name="altura" required><br>
			<input type="submit" name="submit" value="Calcular área" class="submit-button">
		</form>
		<?php
		if (isset($_POST['submit'])) {
			...
			$altura = $_POST['altura'];
			$area = ($base * $altura) / 2;
			echo "<p class='resultado'>El área del triángulo es: " . $area . "</p>";
		}
		?>
	</div>
</body>
