...
<body>
	...
	<nav class="menu">
		...
		<br>
	<div class="container">
	<h2>Calcular el precio de las llantas</h2>
		<form action="llantas.php" method="post" class="nota-form">

			Ingrese el número de llantas:

			<input type="number" name="llantas" required><br> 
		...
		if (isset($_POST['submit'])) {
    		...
    		if ($llantas >= 5) {
       		 $precio = $llantas * 70000;
    		} else {
     	   $precio = $llantas * 80000;
    		}

    	echo "<p class='resultado'>El precio de las llantas es: $" . $precio . "</p>";
		}
		?>
	</div>
</body>
