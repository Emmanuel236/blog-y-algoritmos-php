...
<body>
	...
	<nav class="menu">
		...
		<br>
	<div class="container">
	<h2>Calcular la altura de caída de un cuerpo</h2>
	<form action="caida.php" method="post" class="caida-form">
		Tiempo en segundos: <input type="number" name="tiempo" required><br> 
		<input type="submit" name="submit" value="Calcular altura" class="submit-button">
	</form>
	<?php
	if (isset($_POST['submit'])) {
		...
		$gravedad = 9.8; // Aceleración debida a la gravedad en m/s²
		
		// Cálculo de la altura
		$altura = 0.5 * $gravedad * pow($tiempo, 2);
		
		echo "<p class='resultado'>La altura de caída del cuerpo es: " . $altura . " metros</p>";
	} 
	?>
	</div>
</body>
