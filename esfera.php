...
<body>
	...
	<nav class="menu">
		...
		<br>
	<div class="container">
	<h2>Calcular el volumen de una esfera</h2>
	<form action="esfera.php" method="post" class="nota-form">
		Radio de la esfera: <input type="number" name="radio" step="0.01" required><br> 
		<input type="submit" name="submit" value="Calcular volumen" class="submit-button">
	</form>
	<?php
	if (isset($_POST['submit'])) {
		...
		echo "<p class='resultado'>El volumen de la esfera es: " . $volumen . " unidades cúbicas.</p>";
	} 
	?>
	</div>
</body>
