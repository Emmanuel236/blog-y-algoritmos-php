...
<body>
	...
	<h2>Calcular el número de pulsaciones</h2>
		<form action="pulsaciones.php" method="post" class="nota-form">
			Ingrese su sexo:
			...
			<input type="submit" name="submit" value="Calcular Pulsaciones" class="submit-button">
		</form>
		<?php
		if (isset($_POST['submit'])) {
			...
			if ($sexo == "Femenino") {
				$numPuls = (220 - $edad) / 10;
				echo "<p class='resultado'>El número de pulsaciones es: " . $numPuls .  "</p>";
			} else {
				$numPuls = (210 - $edad) / 10;
				echo "<p class='resultado'>El número de pulsaciones es: " . $numPuls .  "</p>";
			}
