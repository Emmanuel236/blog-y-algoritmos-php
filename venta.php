...
<body>
	...
	<nav class="menu">
		...
		<br>
	<div class="container">
	<h2>Calcular el descuento en la venta</h2>
	<form action="venta.php" method="post" class="venta-form">
		Precio de compra: <input type="number" name="precio_compra" required><br>
	...
	if (isset($_POST['submit'])) {
		...
		if ($precio_compra > 100) {
			...
			$total_a_pagar = $precio_compra - $descuento;
		} else {
			$descuento = $precio_compra * 0.02;
			$total_a_pagar = $precio_compra - $descuento;
		}
		
		echo "<p class='resultado'>El descuento aplicado es: $" . $descuento .  "</p>";
		echo "<p class='resultado'>El total a pagar es: $" . $total_a_pagar .  "</p>";
	} 
	?>
	</div>
</body>
